    ...
    <header className="sticky top-0 z-50">
      ...
      <div className="bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 py-4 text-center text-sm">
          ...
          <span>
            Use code{" "}
            <span className="font-mono" style={{ fontSize: "inherit" }}>
              SAVE20
            </span>
          </span>
          <Link href="/products" className="underline underline-offset-2 ml-2">
            Shop now
          </Link>
        </div>
      </div>
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <Link
                ...
                className="text-gray-700 hover:text-gray-900 hover:underline hover:decoration-primary hover:decoration-2 underline-offset-4"
              >
                Products
              </Link>
              ...
              {categories.map((category) => (
                <Link
                  ...
                  className="text-gray-700 hover:text-gray-900 capitalize hover:underline hover:decoration-primary hover:decoration-2 underline-offset-4"
                >
                  {category.name}
                </Link>
              ))}
