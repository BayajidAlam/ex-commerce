...
export default function BannerSlider() {
  ...
  const slides = [
    {
      id: 1,
      image: "/placeholder.svg?height=500&width=1200&text=Summer+Collection+2024",
    ...
    {
      id: 2,
      image: "/placeholder.svg?height=500&width=1200&text=Premium+Panjabi+Collection",
    ...
    {
      id: 3,
      image: "/placeholder.svg?height=500&width=1200&text=Casual+Shirts+Sale",
