...
export function ProductsClient({ 
  ...
  const handleCategoryChange = (categoryId: string, checked: boolean) => {
    ...
    console.log('🏷️ Category changed:', { categoryId, checked, newCategories, newParams })
  ...
  const handleSortChange = (newSortBy: string) => {
    ...
    const newParams = {
      ...
      sortOrder: newSortBy.includes('high') ? 'desc' : newSortBy.includes('low') ? 'asc' : undefined,
      page: '1'
    }
                    ...
                    <div className="flex items-center space-x-1">
                      {pagination.pages === 0 ? (
                        ...
                        <>
                          ...
                          {Array.from({ length: Math.min(5, Math.max(1, pagination.pages)) }, (_, index) => {
                            let pageNum;
